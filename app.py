...
def detect_faces():
    ...
    while detect_flag:
        ...
        for (x, y, w, h) in faces:
            ...
            emotion_index = prediction.recognize_emoji('C:\\Users\\Asus\\Desktop\\Siddu Galeech Gang\\captured faces')
...
st.markdown('<h1 class="title">Emojify</h1>', unsafe_allow_html=True)
